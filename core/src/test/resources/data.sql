...
insert into category(id, name) values (1, 'Base category');

insert into product(id, name, unit_id, category_id) values (1, 'chefir jlc 1%', 1, 1);
insert into product(id, name, unit_id, category_id) values (2, 'chefir jlc 2.5%', 1, 1);
insert into product(id, name, unit_id, category_id) values (3, 'Inghetata Beriozka 1kg', 1, 1);
