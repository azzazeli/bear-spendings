...
class UIBillItemTest {
    ...
    void validateProductId() {
        UIBillItem uiBillItem = UIBillItem.builder().quantity(1).productName("Peste").price(2.9).build();
    ...
    void validateProductInfo() {
        assertValidUiBillItem(validator.validate(UIBillItem.builder().productId(1L).quantity(1).price(2.2).build()));
        assertValidUiBillItem(validator.validate(UIBillItem.builder().productName("Lapte").quantity(1).price(2.2).build()));
        UIBillItem invalid = UIBillItem.builder().quantity(1).price(2.2).build();
